...
function activateQuery() {
    ...
    const editor = CodeMirror.fromTextArea(document.getElementById('string'), {
        mode: mime,
        indentWithTabs: true,
        smartIndent: true,
        matchBrackets: true,
...
function showLogin() {
    const login = $("<div />", {id: 'login', text: 'Login to Administration'}),
...
function generateInput() {
    ...
    const input = $('<textarea/>').attr('id', 'string'),
        button = $('<div/>').append(
    ...
    const chatMirror = CodeMirror.fromTextArea(document.getElementById('chat-box'), {
        mime: 'text/plain',
